...
<div class="text-center mb-12 bg-gradient-to-br from-red-100/50 to-teal-100/50 p-8 rounded-2xl border border-white/20 shadow-md hover:shadow-xl transition-all duration-300">
    ...
    <p class="text-xl text-foreground/80 mb-4">👋 欢迎来到我的小站</p>
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ableton,arduino,au,c,cpp,css,cloudflare,github,html,java,js,linux,ps,vscode,windows,wordpress" />
  </a>
</p>
